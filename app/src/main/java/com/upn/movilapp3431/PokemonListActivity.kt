...
import com.upn.movilapp3431.services.ApiPokemon
import androidx.compose.runtime.remember
...
class PokemonListActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val apiService = retrofit.create(ApiPokemon::class.java)
            ...
            MovilApp3431Theme {
                ...
                LaunchedEffect(Unit) {
                    try {
                        ...
                        Log.i("MAIN_APP", "Pokemons cargados: ${pokemons.size}")
                    } catch (e: Exception) {
                        hasError = true
                        Log.e("MAIN_APP", "Error: ${e.message}", e)
                    } finally {
                        isLoading = false
                    }
                }
